...
float GlobeRenderer::Math::SignedAngleBetween(const QVector3D& V1, const QVector3D& V2, const QVector3D& Axis)
{
...
QVector3D GlobeRenderer::Math::ProjectOntoPlane(const QVector3D& Vector, const QVector3D& PlaneNormal)
{
    return Vector - QVector3D::dotProduct(Vector, PlaneNormal) * PlaneNormal;
}

QQuaternion GlobeRenderer::Math::RotationBetweenVectors(const QVector3D& V0, const QVector3D& V1)
{
...
bool GlobeRenderer::Math::IntersectRayPlane(const QVector3D& RayOrigin, const QVector3D& RayDir, const QVector3D& PlanePoint, const QVector3D& PlaneNormal, QVector3D& IntersectionPoint)
{
...
bool GlobeRenderer::Math::IntersectRaySphere(const QVector3D& RayOrigin, const QVector3D& RayDirection, const QVector3D& SphereCenter, float SphereRadius, QVector3D& OutIntersectionPoint)
{
